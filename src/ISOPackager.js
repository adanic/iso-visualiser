...
let { IFA_NUMERIC, IFA_BITMAP, IFA_LLNUM, IFA_LLLNUM, IF_CHAR, IFA_LLCHAR, IFA_LLLCHAR, IFA_BINARY, IFA_LLBINARY, IFA_LLLBINARY, IFA_AMOUNT } = packer
let fld = [
  ...
  /* 044 */ new IFA_LLCHAR(99, 'ADITIONAL RESPONSE DATA (MODIFIED FOR ISC)'),
...
class ISO858387APackager extends ISOBasePackager {
  constructor () {
    super()
...
export default new ISO858387APackager()
